          ...
          {data.blocks.map(item =>
            <div className='flex gap-5 py-8 px-6 hover:bg-weart-50 transition-all rounded'>
              ...
              <div>
                ...
                <p>{item.desc}</p>
                <a href={item.link.url} className="hover:border-weart-500 border-b-2 mt-4 font-display text-sm uppercase inline-flex items-center gap-3 font-bold hover:gap-4 transition-all">
                  {item.link.title}
